...
class Patient:
    ...
    def get_cost_treatment(self):
        return Data.NO_TREATMENT_COST *365
    ...
    def get_total_costs(self):
        cost_no_treatment = Data.NO_TREATMENT_COST*365
        ...
        total_costs = cost_no_treatment + cost_urinalysis + cost_UTI_diagnosis + cost_UTI_not_cured + \
