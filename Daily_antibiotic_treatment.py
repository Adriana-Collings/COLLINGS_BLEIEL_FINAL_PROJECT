...
class Patient(object):
    ...
    def simulate(self, n_of_days):
        ...
        for i in range(n_of_days):
            if self._rnd.random_sample() < (self._probUTI*Data.DAILY_ANTIBIOTIC_RR):
                # relative risk of acupuncture prophylaxis
                count_UTIs += 1
                self._countUTIs +=1
    ...
    def get_costs(self):
        return Data.DAILY_ANTIBIOTIC_COST*365 # daily cost of acupuncture prophylaxis for 1 year
